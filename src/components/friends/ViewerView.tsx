                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className={`text-xs font-mono ${isDark ? 'text-white/40' : 'text-[#2b193e]/40'}`}>
                            {player.alias && <span className="mr-2">{player.fullName}</span>}
                            {player.position}
                          </div>
                        </div>
          ...
          >
            {players.length === 0 ? (
              <div className="glass-card rounded-xl p-12 text-center">
                ...
                <p className={`${isDark ? 'text-white/60' : 'text-[#2b193e]/60'}`}>El administrador aún no ha registrado jugadores.</p>
              </div>
            ) : (
