...
function Home() {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ${isDark ? "bg-[#1a1a1a]" : "bg-[#f5f0fa]"}`}
    >
      {/* Header */}
      <div
        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#2ac6ff] to-[#30106b] flex items-center justify-center">
